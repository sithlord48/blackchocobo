...
QImage FF7Item::imageMateriaSlotNoGrowth(void){return QImage(m_no_grow_slot_xpm);}
QImage FF7Item::imageMateriaSlot(void){return QImage(m_grow_slot_xpm);}
QImage FF7Item::imageMateriaLink(void){return QImage(mlink_xpm);}
