...
void CharEditor::Level_Changed(int level)
{
    ...
    if (autolevel) {
        ...
        sb_total_exp->setValue(int(data.exp));
...
void CharEditor::setMaxHp(int maxHp)
{
    ...
    data.maxHP = quint16(std::clamp(maxHp, 0, 32767));
...
void CharEditor::setCurHp(int curHp)
{
    ...
    data.curHP = quint16(std::clamp(curHp, 0, 32767));
...
void CharEditor::setMaxMp(int maxMp)
{
    ...
    data.maxMP = quint16(std::clamp(maxMp, 0, 32767));
...
void CharEditor::setCurMp(int curMp)
{
    ...
    data.curMP = quint16(std::clamp(curMp, 0, 32767));
...
void CharEditor::setKills(int kills)
{
    ...
    data.kills = quint16(std::clamp(kills, 0, 65535));
    emit kills_changed(data.kills);
}

void CharEditor::setName(const QString &newName)
{
    if (_name == newName) {
        return;
    }
...
void CharEditor::setId(int id)
{
    ...
    data.id = quint8(std::clamp(id, 0, 0x0B));
...
void CharEditor::setStr(int strength)
{
    ...
    data.strength = quint8(std::clamp(strength, 0, 0xFF));
...
void CharEditor::setVit(int vitality)
{
    ...
    data.vitality = quint8(std::clamp(vitality, 0, 0xFF));
...
void CharEditor::setMag(int magic)
{
    ...
    data.magic = quint8(std::clamp(magic, 0, 0xFF));
...
void CharEditor::setSpi(int spirit)
{
    ...
    data.spirit = quint8(std::clamp(spirit, 0, 0xFF));
...
void CharEditor::setDex(int dexterity)
{
    ...
    data.dexterity = quint8(std::clamp(dexterity, 0, 0xFF));
...
void CharEditor::setLck(int luck)
{
    ...
    data.luck = quint8(std::clamp(luck, 0, 0xFF));
...
void CharEditor::setStrBonus(int strength_bonus)
{
    ...
    data.strength_bonus = quint8(std::clamp(strength_bonus, 0, 0xFF));
...
void CharEditor::setVitBonus(int vitality_bonus)
{
    ...
    data.vitality_bonus = quint8(std::clamp(vitality_bonus, 0, 0xFF));
...
void CharEditor::setMagBonus(int magic_bonus)
{
    ...
    data.magic_bonus = quint8(std::clamp(magic_bonus, 0, 0xFF));
...
void CharEditor::setSpiBonus(int spirit_bonus)
{
    ...
    data.spirit_bonus = quint8(std::clamp(spirit_bonus, 0, 0xFF));
...
void CharEditor::setDexBonus(int dexterity_bonus)
{
    ...
    data.dexterity_bonus = quint8(std::clamp(dexterity_bonus, 0, 0xFF));
...
void CharEditor::setLckBonus(int luck_bonus)
{
    ...
    data.luck_bonus = quint8(std::clamp(luck_bonus, 0, 0xFF));
...
void CharEditor::setLimitBar(int limitbar)
{
    ...
    data.limitbar = quint8(std::clamp(limitbar, 0, 0xFF));
...
void CharEditor::setWeapon(int weapon)
{
    ...
    weapon = std::clamp(weapon , 0, Chars.numberOfWeapons(data.id));
...
void CharEditor::setAccessory(int accessory)
{
    ...
    accessory = std::clamp<int>(accessory, 0 , 32);
    if (accessory == 32)
...
void CharEditor::setLimits(int limits)
{
    ...
    data.limits = quint16(std::clamp(limits, 0, 32767));
...
void CharEditor::setTimesused1(int timesused)
{
    ...
    data.timesused1 = quint16(std::clamp(timesused, 0, 65535));
...
void CharEditor::setTimesused2(int timesused)
{
    ...
    data.timesused2 = quint16(std::clamp(timesused, 0, 65535));
...
void CharEditor::setTimesused3(int timesused)
{
    ...
    data.timesused3 = quint16(std::clamp(timesused, 0, 65535));
...
void CharEditor::setBaseHp(int baseHp)
{
    ...
    data.baseHP = quint16(std::clamp(baseHp, 0, 32767));
...
void CharEditor::setBaseMp(int baseMp)
{
    ...
    data.baseMP = quint16(std::clamp(baseMp, 0, 32767));
...
void CharEditor::setExp(int exp)
{
    ...
    data.exp = quint32(std::max(exp, 0));
...
void CharEditor::setExpNext(int expNext)
{
    ...
    data.expNext = quint32(std::max(expNext, 0));
...
void CharEditor::calc_stats(void)
{
    ...
    if (autostatcalc) {
        ...
        for (int i = 0; i < 16; i++) {
            if (data.materias[i].id != FF7Materia::EmptyId) {
                bool add = true;
                int level = 0;
                int aptemp = int(Materias.ap2num(data.materias[i].ap));
                ...
                switch (i) {
                case 0:
                    add = weapon_slot_1->isVisible();
                    break;
                case 1:
                    add = weapon_slot_2->isVisible();
                    break;
                case 2:
                    add = weapon_slot_3->isVisible();
                    break;
                case 3:
                    add = weapon_slot_4->isVisible();
                    break;
                case 4:
                    add = weapon_slot_5->isVisible();
                    break;
                case 5:
                    add = weapon_slot_6->isVisible();
                    break;
                case 6:
                    add = weapon_slot_7->isVisible();
                    break;
                case 7:
                    add = weapon_slot_8->isVisible();
                    break;
                case 8:
                    add = armor_slot_1->isVisible();
                    break;
                case 9:
                    add = armor_slot_2->isVisible();
                    break;
                case 10:
                    add = armor_slot_3->isVisible();
                    break;
                case 11:
                    add = armor_slot_4->isVisible();
                    break;
                case 12:
                    add = armor_slot_5->isVisible();
                    break;
                case 13:
                    add = armor_slot_6->isVisible();
                    break;
                case 14:
                    add = armor_slot_7->isVisible();
                    break;
                case 15:
                    add = armor_slot_8->isVisible();
                    break;
                }
                if (add) {
    ...
    sb_maxHp->setValue(int(data.baseHP + (data.baseHP * (hp_bonus * .01))));
    lbl_hp_max->setText(QString(" %1").arg(QString::number(sb_maxHp->value())));
    sb_maxMp->setValue(int(data.baseMP + (data.baseMP * (mp_bonus * .01))));
...
void CharEditor::update_materia_slots()
{
    ...
    case 8: weapon_slot_8->setHidden(0); [[fallthrough]];
    case 7: weapon_slot_7->setHidden(0); [[fallthrough]];
    case 6: weapon_slot_6->setHidden(0); [[fallthrough]];
    case 5: weapon_slot_5->setHidden(0); [[fallthrough]];
    case 4: weapon_slot_4->setHidden(0); [[fallthrough]];
    case 3: weapon_slot_3->setHidden(0); [[fallthrough]];
    case 2: weapon_slot_2->setHidden(0); [[fallthrough]];
    ...
    case 8: armor_slot_8->setHidden(0); [[fallthrough]];
    case 7: armor_slot_7->setHidden(0); [[fallthrough]];
    case 6: armor_slot_6->setHidden(0); [[fallthrough]];
    case 5: armor_slot_5->setHidden(0); [[fallthrough]];
    case 4: armor_slot_4->setHidden(0); [[fallthrough]];
    case 3: armor_slot_3->setHidden(0); [[fallthrough]];
    case 2: armor_slot_2->setHidden(0); [[fallthrough]];
...
void CharEditor::mButtonPress(int Mslot)
{
    ...
    if (Mslot != mslotsel) {
        mslotsel = Mslot;
        materia_edit->setMateria(char_materia(mslotsel).id, qint32(Materias.ap2num(char_materia(mslotsel).ap)));
        setSlotFrame();
