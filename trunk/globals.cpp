...
{
    QT_TRANSLATE_NOOP("Materia_Stats","Maxp:+% depending on level"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:+% depending on level"),QT_TRANSLATE_NOOP("Materia_Stats","Dex:+% depending on level"),QT_TRANSLATE_NOOP("Materia_Stats","Mag:+% depending on level"),QT_TRANSLATE_NOOP("Materia_Stats","Lck:+% depending on level"),
    ...
    QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),
    QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Str:-2 Vit:-1 Mag:+2 Spi:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),
    QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Str:-1 Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Str:-2 Vit:-1 Mag:+2 Spi:+1"),"ID:0x3F",
    QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Str:-2 Vit:-1 Mag:+2 Spi:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Str:-2 Vit:-1 Mag:+2 Spi:+1"),"ID:0x42","ID:0x43",QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Str:-2 Vit:-1 Mag:+2 Spi:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+10% Str:-4 Vit:-2 Mag:+4 Spi:+2"),
    QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+10% Str:-4 Vit:-2 Mag:+4 Spi:+2"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+10% Str:-4 Vit:-2 Mag:+4 Spi:+2"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+10% Str:-4 Vit:-2 Mag:+4 Spi:+2"),"",QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Mag:+1"),
    QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-2% Maxp:+2% Mag:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Mag:+1 Spi:+1"),
    QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Mag:+1 Spi:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Mag:+1 Spi:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Mag:+1 Spi:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-5% Maxp:+5% Mag:+1 Spi:+1"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+10% Mag:+2 Spi:+2"),
    QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+10% Mag:+2 Spi:+2"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+15% Mag:+4 Spi:+4"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+15% Mag:+4 Spi:+4"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+15% Mag:+4 Spi:+4"),QT_TRANSLATE_NOOP("Materia_Stats","MaxHp:-10% Maxp:+20% Mag:+8 Spi:+8"),""
};
static const char *materiaSkills[91][5]=
{
    ...
    {QT_TRANSLATE_NOOP("Materia_Skills","Steal"),QT_TRANSLATE_NOOP("Materia_Skills","Mug"),QT_TRANSLATE_NOOP("Materia_Skills","Mastered"),"",""},{QT_TRANSLATE_NOOP("Materia_Skills","Sense"),QT_TRANSLATE_NOOP("Materia_Skills","Mastered"),"","",""},{"?","?","?","?","?"},
    ...
    {QT_TRANSLATE_NOOP("Materia_Skills","Confu (18mp)"),QT_TRANSLATE_NOOP("Materia_Skills","Berserk (28mp)"),QT_TRANSLATE_NOOP("Materia_Skills","Mastered"),"",""},{QT_TRANSLATE_NOOP("Materia_Skills","Mini (10mp)"),QT_TRANSLATE_NOOP("Materia_Skills","Toad (14mp)"),QT_TRANSLATE_NOOP("Materia_Skills","Mastered"),"",""},
    ...
    {QT_TRANSLATE_NOOP("Materia_Skills","Barrier (16mp)"),QT_TRANSLATE_NOOP("Materia_Skills","M-Barrier (24mp)"),QT_TRANSLATE_NOOP("Materia_Skills","Reflect (30mp)"),QT_TRANSLATE_NOOP("Materia_Skills","Wall (58mp)"),QT_TRANSLATE_NOOP("Materia_Skills","Mastered")},{"?","?","?","?","?"},
