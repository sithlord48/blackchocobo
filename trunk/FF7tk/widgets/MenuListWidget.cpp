...
void MenuListWidget::cb_item_one_toggled(bool checked){emit(box1_toggled(0,checked));}
void MenuListWidget::cb_item_two_toggled(bool checked){emit(box2_toggled(0,checked));}
void MenuListWidget::cb_magic_one_toggled(bool checked){emit(box1_toggled(1,checked));}
void MenuListWidget::cb_magic_two_toggled(bool checked){emit(box2_toggled(1,checked));}
void MenuListWidget::cb_materia_one_toggled(bool checked){emit(box1_toggled(2,checked));}
void MenuListWidget::cb_materia_two_toggled(bool checked){emit(box2_toggled(2,checked));}
void MenuListWidget::cb_equip_one_toggled(bool checked){emit(box1_toggled(3,checked));}
void MenuListWidget::cb_equip_two_toggled(bool checked){emit(box2_toggled(3,checked));}
void MenuListWidget::cb_status_one_toggled(bool checked){emit(box1_toggled(4,checked));}
void MenuListWidget::cb_status_two_toggled(bool checked){emit(box2_toggled(4,checked));}
void MenuListWidget::cb_order_one_toggled(bool checked){emit(box1_toggled(5,checked));}
void MenuListWidget::cb_order_two_toggled(bool checked){emit(box2_toggled(5,checked));}
void MenuListWidget::cb_limit_one_toggled(bool checked){emit(box1_toggled(6,checked));}
void MenuListWidget::cb_limit_two_toggled(bool checked){emit(box2_toggled(6,checked));}
void MenuListWidget::cb_config_one_toggled(bool checked){emit(box1_toggled(7,checked));}
void MenuListWidget::cb_config_two_toggled(bool checked){emit(box2_toggled(7,checked));}
void MenuListWidget::cb_phs_one_toggled(bool checked){emit(box1_toggled(8,checked));}
void MenuListWidget::cb_phs_two_toggled(bool checked){emit(box2_toggled(8,checked));}
void MenuListWidget::cb_save_one_toggled(bool checked){emit(box1_toggled(9,checked));}
void MenuListWidget::cb_save_two_toggled(bool checked){emit(box2_toggled(9,checked));}
