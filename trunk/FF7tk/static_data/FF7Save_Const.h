...
static const quint8 stat_grade[11][5]=
{
  {1,6,3,4,26},
  {5,2,18,14,29},
  {6,18,16,9,25},
  ...
  {21,22,6,4,28},
  {11,7,17,15,27},
  {1,6,3,4,26}, //Y Cloud (Temp, we need to be find the right curve)
  {1,6,3,4,26}  //Seph (Temp, we need to be find the right curve)
};
static const int mp_base[11][8]=
{
    ...
    {16,0,-30,-68,-116,-96,-6,188}, //Y Cloud (Temp, we need to be find the right curve)
    {16,0,-30,-68,-116,-96,-6,188}  //Seph (Temp, we need to be find the right curve)
};
static const quint8 mp_gradent[11][8]=
{
    ...
    {70,84,99,112,124,120,105,82},//Y Cloud (Temp, we need to be find the right curve)
    {70,84,99,112,124,120,105,82} //Seph (Temp, we need to be find the right curve)
};
static const int hp_base[11][8]=
{
    ...
    {200,0,-760,-1840,-2840,-2840,-1160,600},//Y Cloud (Temp, we need to be find the right curve)
    {200,0,-760,-1840,-2840,-2840,-1160,600} //Seph (Temp, we need to be find the right curve)
};
static const quint8 hp_gradent[11][8]=
{
    ...
    {22,45,82,118,143,143,115,95},//Y Cloud (Temp, we need to be find the right curve)
    {22,45,82,118,143,143,115,95} //Seph (Temp, we need to be find the right curve)
};
static const quint8 luck_base[11][8]=
{
    ...
    {14,15,15,16,17,17,17,20},
    {14,15,15,15,16,17,18,20},
    {16,17,17,17,18,18,18,19},//Y Cloud (Temp, we need to be find the right curve)
    {16,17,17,17,18,18,18,19} //Seph (Temp, we need to be find the right curve)
};
static const quint8 luck_gradent[11][8]=
{
    {20,10,10,8,8,8,7,6},
    {15,8,8,7,6,5,4,3},
    ...
    {20,10,10,9,9,10,10,6},
    {15,8,8,7,6,5,4,3},
    {20,10,10,10,8,10,10,9},//Y Cloud (Temp, we need to be find the right curve)
    {20,10,10,10,8,10,10,9} //Seph (Temp, we need to be find the right curve)
};
...
static const int unknown_zmax = 40; //Max Z num
